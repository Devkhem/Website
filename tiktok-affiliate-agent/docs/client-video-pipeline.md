...
คำตอบเรื่องสัดส่วนภาพถูกแปลงเป็นตัวเลขตั้งแต่ตอนรับงาน `แนวตั้ง` เป็น `9:16`
`Landscape` เป็น `16:9` จะได้ไม่ไปพังตอนตรวจไฟล์ final หลังจ่ายค่าทำภาพไปแล้ว
...
ช็อตหนึ่งต้องมีไฟล์เดียว ถ้ามีทั้ง .png และ .jpg ระบบจะไม่เดาว่าอันไหนใหม่กว่า
